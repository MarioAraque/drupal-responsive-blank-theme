 ...
 *   also be "maintenance_page" since responsive_blank_theme_preprocess_maintenance_page() calls
 *   this function to have consistent variables.
 */
function responsive_blank_theme_preprocess_html(&$variables, $hook) {
  // Add variables and paths needed for HTML5 and responsive support.
  $variables['base_path'] = base_path();
  $variables['theme_path'] = drupal_get_path('theme', 'responsive_blank_theme');
 ...
 */
function responsive_blank_theme_process_html(&$variables, $hook) {
 ...
 */
function responsive_blank_theme_preprocess_page(&$variables, $hook) {
 ...
 *   An array of variables to pass to the theme template.
 */
function responsive_blank_theme_process_page(&$variables) {
 ...
 */
function responsive_blank_theme_preprocess_node(&$variables, $hook) {
 ...
 */
function responsive_blank_theme_preprocess_comment(&$variables, $hook) {
 ...
 */
function responsive_blank_theme_preprocess_taxonomy_term(&$variables) {
  // Add a suggestion based on view_mode.
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function responsive_blank_theme_preprocess_block(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function responsive_blank_theme_process_block(&$variables, $hook) {
 ...
 *   An array of variables to pass to the theme template.
 */
function responsive_blank_theme_preprocess_panels_pane(&$variables) {
 ...
 */
function responsive_blank_theme_css_alter(&$css) {
